...
export let counties_pop = `
  <div id="pop" style="display: none;">
    ...
    <div class="Footer">
      <div class="FootLeft">
        <p>Source: American Community Survey 5-Year Estimates (Date Last Accessed: May 28, 2024)</p>
      </div>
    </div>
    </div>
  </div>
...
export let counties_empl_edu_gend = `
  <div id="empl_edu_gend" style="display: none">
    ...
    <div class="Footer">
      <p id ="bottom part1">Note: NIL are individuals who are not in the labor force; this includes retirees and others who are not looking for work <br> <br> Source: American Community Survey 5-Year Estimates (Date Last Accessed: May 28, 2024) <br> <br>"S" Represents suppressed counts that are less than 3.</p>
    </div>
    </div>
  </div>
  `
export let counties_empl_race_ethn = `
  <div id="empl_race_ethn" style="display: none">
    ...
    <div class="Footer">
      <p id="empl_race_ethn_footer">Source: American Community Survey 5-Year Estimates (Date Last Accessed: May 28, 2024) <br> <br>"S" Represents suppressed counts that are less than 3.</p>
    </div>
    </div>
  </div>
  `
export let counties_empl_vet = `
  <div id="empl_vet" style="display: none">
    ...
    <div class="Table">
      ...
      <div class="Footer">
        <p id="empl_vet_chart_footer">Source: American Community Survey 5-Year Estimates (Date Last Accessed: May 28, 2024)<br><br>"S" Represents suppressed counts that are less than 3.</p>
      </div>
    </div>
  </div>
  `
export let counties_disabl_pov = `
  <div id="disabl_pov" style="display: none">
    ...
    <div class="Table">
      ...
      <div class="Footer">
        <div class="FootLeft">
          <p id="disabl_pov_chart_footer">Source: American Community Survey <span id='acsyearagg'>5</span>-Year Estimates (Date Last Accessed: May 28, 2024)</p>
        </div>
      </div>
    </div>
  </div>
...
export let counties_tanf = `
  <div id="tanf" style="display: none">
    ...
    <div class="Table">
      ...
      <div class="Footer">
        <div class="FootLeft">
          <p id="tanf_chart_footer">Source: Administrative Data from Temporary Assistance to Needy Families (TANF) and MD Wage Records (Date Last Accessed: May 28, 2024) <br><br> "--" means data is not available. </p>
        </div>
      </div>
    </div>
  </div>
